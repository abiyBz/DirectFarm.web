...
const WareSide: React.FC = () => {
  ...
  return (
    <div className="bg-gray-800 text-white h-screen w-60 fixed top-0 left-0 overflow-y-auto">
      <div className="p-6 flex items-center justify-between">
        <Link to="/" className="flex items-center space-x-4">
          <img
            src="../logo-bg-removed.png"
      ...
      {isLoggedIn && (
        <button 
          ...
          className="absolute bottom-4 left-4 px-4 py-2 bg-red-500 rounded hover:bg-red-600"
        >
          Logout
        </button>
      )}
