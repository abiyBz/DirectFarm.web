  ...
  useEffect(() => {
    const fetchLatestProducts = async () => {
      try {
        ...
        const sortedProducts = productsWithImages.sort(
          (
  ...
  return (
    <div className="px-6 py-12 bg-gray-100">
      <h1 className="text-4xl font-semibold mb-8">
        {language === "en" ? "Latest Products" : "አዳዲስ ምርቶች"}
      </h1>
      ...
      <div className="flex justify-center items-center">
        <Link to="/all-products">
          <button className="flex mt-5 text-center bg-green-700 text-white outline hover:bg-white hover:text-green-500 rounded p-4 font-medium transition hover:scale-105">
